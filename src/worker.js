...
function validateCloudNode(payload) {
  ...
  const clean = validate({
    ...
    ...fields(payload.system, ['cpu_percent', 'ram_percent', 'ram_total_gb',
      'ram_used_gb', 'total_disk_gb', 'used_disk_gb', 'free_disk_gb', 'disk_percent', 'disk_path'])
  }, 'node');
